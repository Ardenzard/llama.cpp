...
llama_kv_cache::llama_kv_cache(
    ...
    for (uint32_t il = 0; il < hparams.n_layer; il++) {
        ...
        ggml_type layer_type_v = type_v;
        {
            ...
            const bool v_is_turbo_local = (type_v == GGML_TYPE_TURBO3_0 || type_v == GGML_TYPE_TURBO4_0 || type_v == GGML_TYPE_TURBO2_0);
            ...
            } else if (adaptive_mode == 5 && v_is_turbo_local && n_layer >= 8) {
            ...
            } else if (adaptive_mode == 6 && v_is_turbo_local && n_layer >= 8) {
            ...
            } else if (adaptive_mode == 7 && v_is_turbo_local && n_layer >= 8) {
